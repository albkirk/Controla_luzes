...
#define SWVer "04.03"                                   // Major.Minor Software version (use String 01.00 - 99.99 format !)
...
void config_defaults() {
    ...
    config.HASSIO_CFG = true;                             // Is HASSIO configured? If not, it should perform the discovery.
